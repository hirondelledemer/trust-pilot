export default function GoogleTitle() {
  return (
    <div className="bg-white p-[24px] border-b-[rgb(229,229,221)] border-b border-solid">
      <div className="items-center flex justify-center">
        ...
        <span>
          <h1 className="text-[rgb(28,28,28)] text-[16px] font-bold">Google</h1>
          <p className="text-[rgb(105,106,106)] text-[16px]">www.google.com</p>
        </span>
      </div>
    </div>
  );
